...
const filePath = path_1.default.resolve(__dirname, "./Data/Listado evaluadores 2025-Que SI evaluaron-V1.xlsx");
...
const outputFilePath = path_1.default.resolve(__dirname, '../evaluatorsData.json');
